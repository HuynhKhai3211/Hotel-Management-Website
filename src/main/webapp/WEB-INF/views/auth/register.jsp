...
<body>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-4">
                            ...
                            <div class="password-requirements mt-2">
                                <div class="req-item" id="req-length"><i class="bi bi-circle"></i> Ít nhất 8 ký tự</div>
                                <div class="req-item" id="req-upper"><i class="bi bi-circle"></i> Ít nhất 1 chữ hoa (A-Z)</div>
                                <div class="req-item" id="req-lower"><i class="bi bi-circle"></i> Ít nhất 1 chữ thường (a-z)</div>
                                <div class="req-item" id="req-digit"><i class="bi bi-circle"></i> Ít nhất 1 số (0-9)</div>
                                <div class="req-item" id="req-special"><i class="bi bi-circle"></i> Ít nhất 1 ký tự đặc biệt (!@#$...)</div>
                            </div>
                        </div>
    ...
    <script>
        ...
        function checkFormValidity() {
            ...
            let isValid = form.checkValidity() && password === confirm && isStrongPassword(password);
